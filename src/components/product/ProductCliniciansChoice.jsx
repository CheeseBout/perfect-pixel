...
function ProductCliniciansChoice() {
  return (
    <div>
      ...
      <div>
        <p>
          336 clinicians share this on FrontrowMD without compensation. Learn more
        </p>
        <div>
            <span>
                <img src="https://assets.app.thefrontrowhealth.com/jijjnma3wz2ktevmvpuoewdnubm0" alt="Dr. Kimberly Rogers, MD" />
                <img src="https://assets.app.thefrontrowhealth.com/yulyi33mil8glzv4b7fhzs5ipnz2" alt="Deerbrook Family Clinic" />
                <img src="https://assets.app.thefrontrowhealth.com/pa8nliuewz7t7g0dmxjawwf0kr5a" alt="Dr. Green" />
            </span>
            <button>Read their reviews</button>
        </div>
      </div>
    </div>
  );
